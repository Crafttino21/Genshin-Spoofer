...
╚██████╔╝███████╗██║ ╚████║███████║██║  ██║██║██║ ╚████║    ███████║██║     ╚██████╔╝╚██████╔╝██║     
 ╚═════╝ ╚══════╝╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝    ╚══════╝╚═╝      ╚═════╝  ╚═════╝ ╚═╝     
        Genshin Version Spoofer by WeepingAngel | GitHub: https://github.com/Crafttino21                                                                                      
                    Version: 1.0  | Build: 1 (GitHub) | Windows Only
'''
...
class warning:
    ...
    def warning_msg():
        ...
        if xsf == "I AGREE":
            ...
            syscalls.Mbox('Genshin Spoofer by WeepingAngel', 'You Dont aceept the Terms of Service!', 16)
            exit()


print(colors.magenta + banner)
syscalls.changeTitle('Genshin Spoofer by WeepingAngel')
syscalls.Mbox('Genshin Spoofer by WeepingAngel', 'Thanks for Download! | Version: 1.0', 64)
